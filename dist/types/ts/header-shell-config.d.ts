...
export type HeaderShellSection = {
    ...
    type: 'actions';
    role: 'pre' | 'post';
    items: HeaderShellAction[];
    presentation?: 'segmented' | 'cluster';
} | {
    type: 'search';
    placeholder?: string;
    shortcut?: string;
    filterButtonLabel?: string;
    filters?: HeaderShellFilterGroup[];
} | {
    type: 'theme';
    modes?: ThemeMode[];
} | {
...
export declare function normalizeSections(sections: HeaderShellSection[]): HeaderShellSection[];
