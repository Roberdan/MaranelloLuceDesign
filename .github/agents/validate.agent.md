...
<!-- v5.0.0 (2026-03-15): wave-only validation, Opus model, batch submitted→done -->
...
```
pending → in_progress → submitted (executor) → done (Thor wave validation)
```
...
- **5.0.0** (2026-03-15): wave-only validation on Opus, remove per-task validate-task (ADR-0047)
