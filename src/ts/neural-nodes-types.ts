...
export type InternalConnection = { a: number; b: number; strength: number };

export type Particle = {
  connection: number; lane: number; t: number; speed: number;
};
...
export type Activation = { at: number; index: number };
