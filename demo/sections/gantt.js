...
export function createGanttSection() {
  ...
  section.innerHTML = `
    <style>
      ...
      #gantt .mn-mini-gantt__head{display:grid;grid-template-columns:180px repeat(6,1fr);gap:var(--space-sm);margin-bottom:var(--space-sm);color:var(--mn-text-muted);font-size:var(--text-micro);text-transform:uppercase;letter-spacing:.08em}
