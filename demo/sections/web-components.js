...
const GROUPS = [
  ...
  { title: 'Controls', items: [
    ...
    { tag: 'mn-command-palette', desc: 'Keyboard-first action launcher for quick navigation and commands.', preview: `<button class="mn-btn mn-btn--ghost-light" data-open="wc-palette">Open palette</button><mn-command-palette id="wc-palette" items='${COMMAND_ITEMS}' placeholder="Type a command"></mn-command-palette>` },
  ...
  { title: 'Layout', items: [
    ...
    { tag: 'mn-detail-panel', desc: 'Slide-over inspection panel for pipeline metadata.', preview: `<button class="mn-btn mn-btn--ghost-light" data-open="wc-detail">Open detail</button><mn-detail-panel id="wc-detail" title="Pipeline detail" sections='${DETAIL_SECTIONS}'></mn-detail-panel>` },
    { tag: 'mn-modal', desc: 'Modal dialog for confirmations, alerts, and quick approvals.', preview: `<button class="mn-btn mn-btn--ghost-light" data-open="wc-modal">Open modal</button><mn-modal id="wc-modal" title="Release review">The us-east-1 deployment lane is ready for final sign-off.</mn-modal>` },
  ] },
  { title: 'Interactive', items: [
    { tag: 'mn-toast', desc: 'Auto-dismissing toast notifications for operator feedback.', preview: `<button class="mn-btn mn-btn--ghost-light" data-toast>Spawn toast</button><div class="mn-wc-toast-stack"><div class="mn-toast mn-toast--success" style="position:relative;margin-top:8px"><div class="mn-toast__content"><strong class="mn-toast__title">Runbook synced</strong><p class="mn-toast__message mn-micro">State refreshed across runtime board.</p></div></div></div>` },
