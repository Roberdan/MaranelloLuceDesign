...
function drawFallbackGraph(host, opts) {
  ...
  const draw = () => {
    ...
    nodes.forEach((n) => {
      ...
      ctx.fillStyle = '#101113'; ctx.font = `600 ${Math.max(10, n.size * 0.8)}px Inter, sans-serif`; ctx.textAlign = 'center'; ctx.textBaseline = 'middle'; ctx.fillText(n.avatar, n.x, n.y + 0.5);
    });
  };
