...
export function createHeatmapSection() {
  ...
  section.innerHTML = `
    ...
    <div class="mn-container"><p class="mn-section-number">12 — Resource Heatmap</p><h2 class="mn-title-section" style="margin-bottom:var(--space-sm)">Resource Heatmaps</h2><p class="mn-body" style="margin-bottom:var(--space-2xl)">Agent utilization grid and compute impact simulation built with Maranello Luce operations data.</p><details class="mn-code-snippet"><summary class="mn-label" style="cursor:pointer;color:var(--mn-accent);margin-bottom:var(--space-sm)">⟨/⟩ Usage</summary><pre class="mn-card-dark" style="padding:var(--space-md);font-family:var(--font-mono);font-size:var(--text-micro);overflow-x:auto;margin-bottom:var(--space-lg);border-left:3px solid var(--mn-accent)"><code>&lt;div class="mn-cap-grid" style="grid-template-columns:180px repeat(3,1fr)"&gt;
  &lt;div class="mn-cap-grid__cell mn-cap-grid__cell--high"&gt;0.9&lt;/div&gt;
  &lt;div class="mn-cap-grid__cell mn-cap-grid__cell--mid"&gt;0.6&lt;/div&gt;
  &lt;div class="mn-cap-grid__cell mn-cap-grid__cell--over"&gt;1.1&lt;/div&gt;
&lt;/div&gt;</code></pre></details><h3 class="mn-title-sub" style="margin-bottom:var(--space-md)">Agent Utilization Grid</h3><div style="margin-bottom:var(--space-2xl);position:relative;overflow-x:auto">${buildCapacityGrid()}</div><div class="mn-divider-gold" style="margin-bottom:var(--space-2xl)"></div><h3 class="mn-title-sub" style="margin-bottom:var(--space-md)">Impact Heatmap with Compute Load</h3>${buildImpactSimulation()}</div>`;
