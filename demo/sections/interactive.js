...
export function createInteractiveSection() {
  ...
  section.innerHTML = `
    <div class="mn-container"><p class="mn-section-number">14 — Interactive Widgets</p><h2 class="mn-title-section mn-mb-sm mn-anim-fadeInUp">Interactive Widgets</h2><p class="mn-body mn-mb-2xl">Full-featured UI patterns: conversational AI, authentication flows, and operator profile management.</p><details class="mn-code-snippet"><summary class="mn-label" style="cursor:pointer;color:var(--mn-accent);margin-bottom:var(--space-sm)">⟨/⟩ Usage</summary><pre class="mn-card-dark" style="padding:var(--space-md);font-family:var(--font-mono);font-size:var(--text-micro);overflow-x:auto;margin-bottom:var(--space-lg);border-left:3px solid var(--mn-accent)"><code>Maranello.aiChat(el, {
  title: 'AI Copilot',
  onSend(text) { return fetchReply(text); }
});
Maranello.loginScreen(el, { appTitle: 'App', onLogin() {} });
Maranello.profileMenu(el, { name: 'John', email: 'john@example.com' });</code></pre></details><div class="mn-grid-3"><div><div class="mn-demo-section-label mn-mb-sm">AI Chat Widget</div><div class="mn-card-dark" style="border-radius:var(--radius-lg);overflow:hidden"><div id="demo-ai-chat" style="height:350px"></div></div></div><div><div class="mn-demo-section-label mn-mb-sm">Login Screen</div><div class="mn-card-dark" style="border-radius:var(--radius-lg);overflow:hidden"><div id="demo-login-screen" style="min-height:350px;display:flex;align-items:center;justify-content:center"></div></div></div><div><div class="mn-demo-section-label mn-mb-sm">Profile Menu</div><div class="mn-card-dark" style="border-radius:var(--radius-lg);overflow:hidden"><div id="demo-profile-menu" style="min-height:350px;display:flex;align-items:center;justify-content:center"></div></div></div></div></div>`;
